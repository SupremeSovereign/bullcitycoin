...
uint256 hashGenesisBlock("0x000000007aeecc59aab937f8c65010b69f3e05c63b869c3d702106875804e206");
...
const string strMessageMagic = "BullCityCoin Signed Message:\n";
...
{
    int64 nSubsidy = 700 * COIN;

    // Subsidy is cut in half every 50000000 blocks, which will occur approximately every 4 years
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x000000007aeecc59aab937f8c65010b69f3e05c63b869c3d702106875804e206");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        block.nVersion = 1;
        block.nTime    = 1393509130;
        block.nBits    = 486604799;
        block.nNonce   = 1223027443;
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("BullCityCoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("BullCityCoinMiner : ProcessBlock, block not accepted");
    }
...
{
    printf("BullCityCoinMiner started\n");
    ...
    try { loop {
        ...
        printf("Running BullCityCoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("BullCityCoinMiner terminated\n");
        throw;
    }
}
